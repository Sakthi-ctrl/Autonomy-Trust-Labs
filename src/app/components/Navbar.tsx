  ...
  return (
    ...
    >
      <div style={{ width: '100%', maxWidth: 1220, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        >
          <img src="/Autonomy-Hummingbird.svg" alt="Autonomy Trust Labs Icon" style={{ height: '32px', width: 'auto' }} />
          <img src="/Autonomy-Wordmark.svg" alt="Autonomy Trust Labs Wordmark" style={{ height: '20px', width: 'auto' }} />
        </a>
