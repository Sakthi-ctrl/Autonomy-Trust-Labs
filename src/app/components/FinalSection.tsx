          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-14 mb-12">
            ...
            <div>
              <div className="mb-6 flex items-center gap-3">
                <img src="/Autonomy-Hummingbird.svg" alt="Autonomy Trust Labs Icon" style={{ height: '36px', width: 'auto' }} />
                <img src="/Autonomy-Wordmark.svg" alt="Autonomy Trust Labs Wordmark" style={{ height: '24px', width: 'auto' }} />
              </div>
