    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '16px' }}>
          <img src="/Autonomy-Hummingbird.svg" alt="Autonomy Trust Labs Icon" style={{ width: '64px', height: 'auto' }} />
          <img src="/Autonomy-Wordmark-Subtitle.svg" alt="Autonomy Trust Labs Wordmark" style={{ width: '220px', height: 'auto' }} />
        </div>
